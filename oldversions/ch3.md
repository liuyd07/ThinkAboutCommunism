...
对应到人类历史上不同阶段和不同生产方式，可以看到生产循环的拓展对社会组成的深刻塑造作用。

在原始社会，主要通过采摘和捕猎来获取食物，生产链条非常简单，生产链条的源头就是大自然，人类只是大自然的搬运工。这种情况下，获得的增量来源于大自然随机产生。环境好的地方物产丰富，环境恶劣的地方产出少，养活的人也少。这时候，生产力可简化定义为：

$$
\delta(P) = rand()
$$

随着部分人不断尝试发现可以通过耕作的方式改变环境，使产出稳定，进而塑造农耕社会，拓展了生产链条，人类开始通过耕作来获取食物。这种情况下，获得的增量来源于人类对大自然的管理，生产力可简化定义为：

$$
\delta(P) = C
$$

可见此时的生产效率是提高的。当然也存在农耕产出低于采摘和捕猎的情况，但总体而言农耕和游牧都是主动控制生产资料，使得产出稳定。

进一步发展到工业社会，生产效率显著提升。这个提升体现在生产正循环的出现，使得生产效率可以指数型提升，但各个行业的提升是不同的。

$$
\delta(P) = \alpha P
$$

这将倒逼生产链条的拓展和加速，因为只要不能实现指数增殖的就会被淘汰。

那么在这种推论下，未来潜在的生产必然朝着指数型增殖发展，且是全方面的指数型增殖。但指数性增殖最快的速度也就是自然指数增值。未来的发展是否可以实现全领域全行业的指数增值？

目前妨碍全社会生产能力指数型增殖的瓶颈在哪里？


理想的状态就是当前的资源出现时，将会在固定时间内完成所有资源充分利用，而非
...
这里就有个很矛盾的地方。如果所有的生产都依赖这个银行贷款，那么银行收到的贷款就包括自己向整个生产系统放出的贷款再加上贷款产生的利息。如果银行只放了一次贷款，那么无论如何市场上也不能有能够偿还这个贷款的货币，因为货币的来源就是银行放出的贷款，没有额外的货币付利息了。因此银行必须在生产链还贷款之前就再贷出一笔款，至少要等于之前的贷款加上利息，否则这个交易游戏就玩不下去了。
...
还有一种货币流动形式，就是没有人欠银行贷款，当前流通的货币量恰好满足交易需要，可以看到货币必然向生产链条的源头流动。如果没有银行介入放贷，那么货币就必须能在生产链条中循环流动。
